                            ...
                            <div className="space-y-10">
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="p-8 glass border border-white/5 hover:border-[#A88464]/30 transition-all duration-500 group/item">
                                        ...
                                        <p className="text-[10px] text-stone-500 leading-relaxed">Autonomous argument testing.</p>
                                    </div>
                                    <div className="p-8 glass border border-white/5 hover:border-[#A88464]/30 transition-all duration-500 group/item">
                                        ...
                                        <p className="text-[10px] text-stone-500 leading-relaxed">Grounded citation engine.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
